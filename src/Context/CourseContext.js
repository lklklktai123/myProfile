  ...
  const dataCourses = [
    ...
    },
    {
      ...
      courseDetail: {
        ...
        description:
          'Has 65 (!!!) hours of video Is modern from the beginning, with a strong focus on ES6+ (even ES2020) features Features more and better projects (see image below) Contains 25+ coding challenges and 25+ assignments Has better and deeper explanations of every single topic',
        images: [
          images.course_js_1,
          images.course_js_2,
          images.course_js_3,
